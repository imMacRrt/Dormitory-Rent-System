                ...
                <div class="pcoded-inner-content">
                  <div class="main-body">
                    <div class="page-wrapper">
                      <!-- Page-body start -->
                      <div class="page-body">
                        <form id = form_search method = "POST" action = "select_room.php">
                          <div class="row">
                            <div class="col-sm-12">
                            ...
                            <table id="demo-foo-filtering" class="table table-striped">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td align="center"><img src="upload/<?php echo $row['roomimage'];?>" width="150px"></td>
                                  <td align="center"><?php echo $row['roomnumber'];?> </td>
                                  <td align="right"><?php echo number_format($row['roomprice']);?> </td>
                                  <td align="center"><?php echo $roomcategory[$row['roomcategory']];?></td>
                                  <td align="center"><?php echo $roomstatus[$row['roomstatus']];?> </td>
                                  <td align="center">
                                  <?php 
                                    if($row['roomstatus']>0){
                                    ...
                                    ?>
                                    <a id="select" class="btn btn-success waves-effect waves-light" value="" href="cart_room.php?roomnumber=<?php echo $row["roomnumber"];?>">เลือก</a>
                                    <?php }?>
                                  </td>
                                </tr>
                                <?php  } ?>
