...
<?php  
    ...
    $search = $_POST['search'];
    if($search!=''){
      $where_condition .= " AND (serviceid LIKE '%".$search."%' OR servicename LIKE '%".$search."%' OR servicecategory LIKE '%".$search."%' )";
      }
?>
...
<?php    
    ...
    $sql = "SELECT * FROM servicelist WHERE servicestatus= 0 AND 1=1 ".$where_condition." ORDER BY serviceid DESC ";
                ...
                <div class="pcoded-inner-content">
                  <div class="main-body">
                    <div class="page-wrapper">
                      <!-- Page-body start -->
                      <div class="page-body">
                        <form id = form_search method = "POST" action = "select_servicelist.php">
                          <div class="row">
                            <div class="col-sm-12">
                            ...
                            <input id="rentid" name="rentid" type="hidden" value="<?php echo $id=$_GET['id']; ?>">
                            <table id="demo-foo-filtering" class="table table-striped">
                              <thead align="center">
                                <tr >
                                  <th width="50">รหัสรายการบริการ</th>
                                  <th width="100">รายการบริการ</th>
                                  <th width="100">ราคาต่อหน่วย(บาท)</th>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td align="center"><a id="select" class="btn btn-success waves-effect waves-light"   value="" href="cart_servicelist.php?serviceid=<?php echo $row["serviceid"];?>">เลือก</a>
                                </tr>
                                <?php  } ?>
                              </tbody>
                            </table>
