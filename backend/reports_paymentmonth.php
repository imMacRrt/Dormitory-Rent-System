  ...
  <tbody>
    <tr>
      <td align="center" valign="top"><table width="445" border="0" align="center">
        <tbody>
          <tr>
            <td align="center" valign="top" bgcolor="#333300"><h3><font color="#FFFFFF">เงื่อนไขรายงานการรับชำระประจำเดือน</font></h3></td>
          </tr>
        </tbody>
      </table>
        <form id="form1" name="form1" method="post" action="report_paymentmonth.php"  target="_blank">
          <br>
          <table width="235" border="0" align="center">
            <tbody>
              <tr>
                <td colspan="2" align="center" valign="middle"><strong>รายงานการรับชำระประจำเดือน</strong></td>
              </tr>
              <tr>
