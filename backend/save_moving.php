...
?>
            ...
            <div class="pcoded-content">
                ...
                <!-- [ breadcrumb ] end -->
                <form id="form_moving" method="POST" action="db_query_moving.php"> 
                    
                    <div class="form-group row">
                        <label class="col-sm-1 col-form-label" align="right"><h6>เลขที่เช่า</h6></label>
                        
                        <span id="rentid" name="rentid" type="text" class="col-sm-2 col-form-label" maxlength="5" ><?php echo $id; ?></span>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-1 col-form-label" align="right" ><h6>รหัสลูกค้า</h6></label>
                        
                        <span id="cusid" name="cusid" type="text" class="col-sm-2 col-form-label" maxlength="5"><?php echo $row['cusid'];?></span>
                        
                        <label class="col-sm-1" align="right" ><h6>ชื่อ-นามสกุล</h6></label>                        
                    ...
                    <div class="form-group row">
                    <label class="col-sm-1" align="right" ><h6>วันที่แจ้งย้าย</h6></label>                        
                        <span id="rentdateinform" name="rentdateinform" class="col-sm-2" ><?php 
                            echo date('d-m-',strtotime($row['rentdateinform']. " + 0 day")).(date('Y',strtotime($row['rentdateinform']. " + 0 day"))+543); ?></span>   

                        <label class="col-sm-1 col-form-label" align="right"><h6>ประเภทย้าย</h6></label>                       
                        <span id="typemove" name="typemove"type="text" class="col-sm-2" ><?php echo $row['type_move'];?></span>
                        <input id="hid_typemove" name="hid_typemove" type="hidden" class="col-sm-2" value="<?php echo $row['type_move'];?>" >             
                    </div>

                    <div class="form-group row">
                    <label class="col-sm-1 col-form-label" align="right"><h6>วันกำหนดย้าย</h6></label>
                        
                        <span id="datedecide" name="datedecide"  class="col-sm-2" ><?php echo date('d-m-',strtotime($row['date_decide']. " + 0 day")).(date('Y',strtotime($row['date_decide']. " + 0 day"))+543);?></span>   

                        <label class="col-sm-1" align="right" ><h6>วันที่ย้าย</h6></label>
                        <?php   
                            if($row['type_move'] = "ย้ายห้อง"){?>                       
                                    <input id="rentdateout" name="rentdateout" type="date" class="col-sm-2" min="<?php echo $row['date_decide'];?>"  > 
                            <?php }else{?>
                                <input id="rentdateout" name="rentdateout" type="date" class="col-sm-2" min="<?php echo $row['rentdateinform'];?>"  >
                            <?php } ?>
                    </div>
                    ...
                    <script  type="text/javascript"> 
                            ...
                            $("#confirmbt").click(function(){
                                ...
                                var hid_typemove = $("#hid_typemove");
                                var hid_typemove_trim = $.trim(hid_typemove.val());

                                var rentdateout = $("#rentdateout");
                                var rentdateout_trim = $.trim(rentdateout.val());

                                if(hid_typemove_trim == ""){
                                alert('กรุณาแจ้งย้าย');
                                return false;
                          
                                }else if(rentdateout_trim == ""){
                                alert('กรุณากำหนดวันที่ย้าย');
                                rentdateout.focus();
                                return false;
