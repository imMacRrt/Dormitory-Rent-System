...
?>
                                ...
                                <div class="page-body">                                    
                                    <table id="demo-foo-filtering" class="table table-striped">
                                            ...
                                            foreach($_SESSION['loop_cart_service'] as $k=>$v)
                                            {
                                                ...
                                                <td align="right"> 
                                                    ...
                                                    ?><p><?php  echo number_format($row2['water_unit']);?><p>
                                                        <input id="water_unitstart" name="unitstart[<?php echo $i; ?>]"  class="css_input1 col-sm-5 col-form-label" style="background-color: #b4cbcb;"  type="hidden" data-number="<?php echo $row2['water_unit'];?>" value="<?php echo $row2['water_unit'];?>" readonly> 
                                                    <?php 
                                                    }elseif($row3["servicename"] == "ค่าไฟ"){//ค่าไฟเริ่มต้น
                                                    ?> <p><?php  echo number_format($row2['elec_unit']);?><p>
                                                        <input id="elec_unitstart" name="unitstart[<?php echo $i; ?>]" class="css_input1 col-sm-5 col-form-label" style="background-color: #b4cbcb;" type="hidden" data-number="<?php echo $row2['elec_unit'];?>" value="<?php echo $row2['elec_unit'];?>" readonly> 
                                                    <?php }else{                                                        
                                                    ?> <p><?php  echo number_format(0);?><p>
                                                        <input id="unitstart" name="unitstart[<?php echo $i; ?>]"  class="css_input1 col-sm-5 col-form-label" style="background-color: #b4cbcb;" type="hidden" data-number="0" value="0" >
                                                    <?php }?>
                                                </td>                                      
                                                <td>
                                                <?php 
                                                    ...
                                                    ?>
                                                    <input id="water_unitend" name="unitend[<?php echo $i; ?>]" type="number" min="<?php echo $row2['water_unit'];?>" class="css_input css_input2 col-sm-5 col-form-label">
                                                    <?php                
                                                    }elseif($row3["servicename"] == "ค่าไฟ"){ //ค่าไฟสิ้นสุด                                                    
                                                    ?>
                                                    <input id="elec_unitend" name="unitend[<?php echo $i; ?>]" type="number" min="<?php echo $row2['elec_unit'];?>" value="<?php echo $row2['elec_unit'];?>" class="css_input css_input2 col-sm-5 col-form-label" >
                                                    <?php 
                                                    }else{ 
                                                    ?>
                                                    <input id="unitend" name="unitend[<?php echo $i; ?>]" type="number" min="1" class="css_input css_input2  col-sm-5 col-form-label txtOnly number_only " data-number="<?php echo 1 ?>" value="1">
                                                    <?php } ?>
                                                </td>
                                                <td>
                                                <?php 
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-weight: bold;" align="right"><input id="invprice" name="invprice" class="col-sm-5 col-form-label"type="text" readonly> &nbsp &nbsp &nbsp บาท</td>   
                                        </tr>
                                        </tfoot>
                                    </table>                          
                                </div>
        ...
        <script  type="text/javascript">
            ...
            $("#confirmbt").click(function(){  
                ...
                var invprice = $("#invprice");
                var invprice_trim = $.trim(invprice.val());
                ...
                }else if(invprice_trim < 0){
                alert('กรุณากรอกยูนิตสิ้นสุดให้ถูกต้อง');
                elec_unitend.focus();
                return false;
