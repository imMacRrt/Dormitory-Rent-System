...
<?php
	...
	$sql = "SELECT a.* , b.* , c.*, d.*
			...
			LEFT JOIN  employee d 	ON a.emid = d.emid
            WHERE invid = '".$id."' ";
  ...
  <tbody>
    <tr>
      ...
      <table width="780" border="0">
        <tbody>
          <tr>
            <td width="160" align="right"><strong>เลขที่ใบเสร็จ :</strong></td>
            <td width="160"><?php echo $row['invreceipt']; ?></td>
          ...
          <tr>
            ...
            <td align="right"><strong>วันที่ชำระเงิน :</strong></td>
            <td><?php echo fn_thai_date($row['invpayment'],"3"); ?></td>
          </tr>
		  <tr>
...
?>
          	...
          	<tr>
				<td width="850" colspan="7" align="right">
					<table width="850" border="1">
						...
						<td align="left" valign="top"><?php echo $row2['serviceunit']; ?></td>
						...
						<tfoot>
							<tr>
								<td colspan="5"> </td>
								<td style="font-weight: bold;" align="left">ค่าปรับ(บาท)</td>
								<td style="font-weight: bold;" align="right"> <?php echo number_format($row['invfines']); ?></td>
							</tr>
							<tr>
								<td colspan="5"> </td>
								<td style="font-weight: bold;" align="left">ยอดชำระ(บาท)</td>
								<td style="font-weight: bold;" align="right"> <?php echo number_format($row['invamount']); ?></td>
							</tr>
						</tfoot>
					</table>
				</td>
	...
	<table width="800" border="0">
          ...
          <tr>
			...
			<?php } ?>
            <td width="160" align="right"><strong>ชื่อพนักงานที่รับชำระ :</strong></td>
            <td width="160"><?php echo $row['emname']; ?></td>
          </tr>
          <tr>
            <td align="right"><strong>ประเภทชำระ :</strong></td>
            <td><?php echo $row['invcategory'];?></td>
			<td align="right"><strong>วันที่พิมพ์ :</strong></td>
            <td><?php echo fn_thai_date($dnow,"2") ; ?></td>
          </tr>
        </tbody>
    </table>
</td>
