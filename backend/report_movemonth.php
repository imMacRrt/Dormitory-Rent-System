...
<head>
<meta charset="UTF-8">
<title>รายงานการย้ายประจำเดือน</title>
</head>
  ...
  <tbody>
    <tr>
      <td align="center"><table width="990" border="0" align="center">
        <tbody>
          <tr>
            <td align="center" valign="top"><h3>รายงานการย้ายประจำเดือน<br>
...
<table border="0">
  <tr>
    <td width="150" align="center" valign="top"><strong>ประเภทย้าย</strong></td>
    <td width="150" align="center" valign="top"><strong>วันที่ย้าย</strong></td>
    <td width="150" align="center" valign="top"><strong>วันกำหนดย้าย</strong></td>
	...
	<td width="150" align="center" valign="top"><strong>รหัสลูกค้า</strong></td>
	<td width="150" align="left" valign="top"><strong>ชื่อ-นามสกุล</strong></td>
	<td width="150" align="center" valign="top"><strong>วันครบสัญญาเช่า</strong></td>
    </tr>
  <tr>
...
<?php
	...
	$sql1 = " SELECT * FROM rent WHERE rentstatus != 1 AND DATE_FORMAT(date_decide,'%Y%m')='".$year.$month."' ORDER BY type_move , rentdateout ASC ";
	...
	while($move = mysqli_fetch_row($result1)){
		...
		if(($newstatus != $type_move) && ($newstatus != null) ){
?>
	<tr>
      <td colspan="8" align="right" valign="top"><strong><font color="<?php echo $color; ?>">รวม</strong></td>
...
?>
    <tr>
      <td align="center" valign="top">
	  		<?php
					if($newstatus == 'ย้ายออก'){ $color = 'purple'; ?>
					<font color ="purple"><strong> ย้ายออก </strong></font>
			<?php
					}elseif($newstatus == 'ย้ายห้อง'){ $color = 'gray'; ?>
      ...
      <td align="center" valign="top"><?php echo fn_thai_date($rentdateout,""); ?></td>
	  ...
	  <td align="center" valign="top"><?php echo fn_thai_date($rentdatelease,""); ?></td>
      </tr>
<?php
...
?>
	...
	<tr>
      <td colspan="8" align="right" valign="top"><strong><font color="purple">รวมย้ายออกทั้งหมด</strong></td>
	  <td colspan="1" align="right" valign="top"><strong><font color="purple"><?php echo ($count2); ?> รายการ</strong></td>
    </tr>
	<tr>
      <td colspan="8" align="right" valign="top"><strong><font color="gray">รวมย้ายห้องทั้งหมด</strong></td>
