...
<script  type="text/javascript"> 
    $(document).ready(function(){
        ...
        $(".delroom").click(function(){
          var ind = $('.delroom').index(this);
          var id_val = $('.delroom').eq(ind).attr('id');
          if(confirm("ยืนยันการลบข้อมูลห้องพัก")){
            window.location.replace("del_room.php?id="+id_val);
          }
        })
    });
</script>
...
<?php    
    $sql = "SELECT * FROM room  WHERE 1=1 ".$where_condition;
                ...
                <div class="pcoded-inner-content">
                  <div class="main-body">
                    <div class="page-wrapper">
                      <!-- Page-body start -->
                      <div class="page-body">
                      <form id = form_search method = "POST" action = "show_room.php">
                          <div class="row">
                            <div class="col-sm-12">
                          ...
                          <div class ="col-sm-11" align="right">
                            <a id="addroom" class="btn btn-primary waves-effect waves-light" align="right" type="button" value="" href="add_room.php">เพิ่ม</a>
                          </div>
                            <table id="demo-foo-filtering" class="table table-striped">
                              <thead align="center">
                                <tr style="font-weight:bold; color: black; font-size:large;">
                                  <td>รูป</td>
                                  <td>หมายเลขห้อง</td>
                                  <td align="right">ราคาห้องพัก (บาท)</td>
                                  <td>สถานะ</td>
                              ...
                              <tbody align="center">
                                ...
                                <tr>
                                  ...
                                  <td><?php if($row['roomimage'] !=''){ ?>
                                  <img src="upload/<?php echo $row['roomimage'];?>" width="150px">
                                      <?php }else{ ?>
                                        <img src="upload/nophoto.jpeg" width="150px">
                                  <?php }
                                  ?></td>
                                  ...
                                  <td><a id="editroom" class="btn btn-warning waves-effect waves-light" type="button" value="" href="add_room.php?id=<?php echo $row['roomnumber'];?>">แก้ไข</a>
                                      <a id="<?php echo $row['roomnumber'];?>" class="delroom btn btn-danger waves-effect waves-light" type="button" value="" href="#">ลบ</a>
                                </tr>
                                <?php  } ?>
                              </tbody>
                            </table>
